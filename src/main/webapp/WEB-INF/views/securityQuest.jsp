...
<div id="intro" class="view hm-black-strong">
		<form:form method= "POST" commandName="user" action="/passwordReset/resetPassword">
...
<table align ="center" style="position: relative; top: 50px;">
		<tr>
      <td><form:label path="securityQuestion" style="position: relative; left:150px;" ><b>Security Question:</b> ${securityQuestion}</form:label></td>
      <td><form:errors path="securityQuestion"  cssClass="error" /></td>
      </tr>
      <tr>
      <td></td>
       <td><form:input path="securityAnswer" style="position: relative; left:-150px;" /></td>
      <td><form:errors path="securityAnswer"  cssClass="error" /></td>
      </tr>
      <tr>
      <td>
            <input type="submit" value="Submit Answer" name="Answer" class="btn btn-default" style="position: relative; left: 130px;"/>
        </td>
     </tr>
     </table>
