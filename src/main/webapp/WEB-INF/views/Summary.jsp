...
#intro {
 ...
 #intro{
 background: url("/images/summary.gif")no-repeat center center fixed;
...
<nav class="navbar navbar-inverse navbar-static-top" style="margin-bottom:0px;" role="navigation">
 ...
 <div class="navbar-header">
        ...
        <div class="collapse navbar-collapse">
          ...
          <li><a href="/leaderboard/"><span class="glyphicon glyphicon-stats"></span> Leaderboard</a></li>
	          <li>
...
<h3>You have completed your GAMES </h3>
<font size="6"><p>
    <hr> 
	...
	<tr>
	<td>Your Overall Score: ${MathsScore+EnglishScore }/24  + Bonus point ${bonus} = ${MathsScore+EnglishScore+ bonus} </td>
	</tr>
	<tr>
	<td><h3>Breakdown Of Results</h3></td>
	</tr>
	
	<tr>
	<td>Maths Score: ${MathsScore}/12</td>
	</tr>
	<tr>
	<td>English Score: ${EnglishScore}/12</td>
	</tr>
	<tr>
	<td>Bonus Points: ${bonus}</td>
	</tr>
  ...
  <td> <div style="text-align:center"><a href = "/"><input type = "button" value = "Want to play again ? " class="btn btn-success"></a></div></td>
	...
	<tr>
  <td> <div style="text-align:center"><a href = "/exam/"><input type = "button" value = "Want to test your knowledge ? " class="btn btn-success"></a></div></td>
