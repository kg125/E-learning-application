      ...
      <c:forEach var ="par" items ="${questions}">
      	<tr>
      		...
      		<td>
      		 ...
      		 <td><a href ="/admin/editExamQuest/${par.id}" class = "btn btn-default">Edit Question</a></td>
      		 <td><a href ="/admin/editExamAnswer/${par.id}" class = "btn btn-default">Edit Answers</a></td>
