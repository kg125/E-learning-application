...
<tr><th> ID</th><td><input type = "number" name ="number"  id="number" value ="${user.id}" readonly disabled></td></tr>
<tr><th> Question</th><td><textarea name = "content" id ="content" placeholder ="Write question here"rows="10" cols="60">${user.content}</textarea></td></tr>
<tr>
	<th> <input type="submit" value="Done" id="submit" class="btn btn-success"/></th>
	<th><a href = "/admin/allQuestions" role ="button" class="btn btn-danger" style="float:right">Back</a></th>
</tr> 
